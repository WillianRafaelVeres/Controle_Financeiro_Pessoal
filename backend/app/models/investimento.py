...
class MovimentoInvestimento(IdMixin, UserOwnedMixin, TimestampMixin, table=True):
    ...
    quantidade: Decimal | None = Field(default=None, sa_column=money_column(nullable=True, casas_decimais=8))
    preco_unitario: Decimal | None = Field(default=None, sa_column=money_column(nullable=True))
